...
public class DialogoDificultad extends JDialog {
	 ...
	 * Create the frame.
	 */
	public DialogoDificultad(Sonidos sonidos, String usuario, int accion, JFrame parent, boolean modal) {
		super(parent, modal);
		...
		btnNivel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				VentanaJuego ex = new VentanaJuego(numTanques,bonificacionDeNivel, DialogoDificultad.this.sonidos,miJugadorDao,jugador);
				ex.setVisible(true);
				dispose();
